...
color_darkred = {}
color_darkred.red = 0.54 -- 138
color_darkred.green = 0.29 -- 76
color_darkred.blue = 0.34 -- 88
...
color_roze = {}
color_roze.red = 0.9 -- 230
color_roze.green = 0.72 -- 184
color_roze.blue = 0.75 -- 193

color_blue = {}
color_blue.red = 0.27 -- 69
color_blue.green = 0.41 -- 107
color_blue.blue = 0.45 -- 115
...
board_height = 480
board_height_blocks = board_height / 20
function draw_game()
    -- background
    --love.graphics.draw(backhs_image, 0, 0)
    love.graphics.setColor(color_roze.red, color_roze.green, color_roze.blue)
    ...
    -- board background
    love.graphics.setColor(color_darkred.red, color_darkred.green, color_darkred.blue)
    love.graphics.rectangle("fill", (640-board_width)/2-5, 0, board_width+10, board_height)
    love.graphics.setColor(0, 0, 0)
    love.graphics.rectangle("fill", (640-board_width)/2, 0, board_width, board_height)
        ...
        for j=1, 20 do
            if grid[i][j] == 1 then
                love.graphics.rectangle("fill",
                    ...
                    board_height - board_height_blocks*j, 
    ...
    love.graphics.rectangle("fill",
        ...
        board_height - board_height_blocks*block.y, 
        board_width_blocks, board_height_blocks)
